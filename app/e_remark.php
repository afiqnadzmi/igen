            ...
            <table id="tableRemark" style="width: 100%;" class="TFtable">
                <thead>
                    <tr class="pluginth">
                        ...
                        <th style="width: 200px;">Date<font color="#E6E6E6">_</font>reported</th>
                        <th style="width: 300px;">Name</th>
						 <th style="width: 300px;">Addedby</th>
						  <th style="width: 300px;">Date<font color="#E6E6E6">_</font>Added</th>
						   <th style="width: 300px;">Incident<font color="#E6E6E6">_</font>happen<font color="#E6E6E6">_</font>off<font color="#E6E6E6">_</font>site</th>
                ...
                while ($newArray = mysql_fetch_array($sql_result1)) {
					...
					<tr class="plugintr">
                        <td><?php echo $num ?></td>
						<td><img src="uploads/leave/<?php echo $newArray['photo'] ?>" width="100px" height="100px"></td>
                        <td <?php echo $mouseover ?>><?php echo $newArray['type'] ?></td>
                        <td <?php echo $mouseover ?>><?php echo $newArray['date_report'] ?></td>
						<td ><?php echo $newArray['name'] ?></td>
						<td ><?php echo $newArray['added'] ?></td>
						<td><?php echo $newArray['date'] ?></td>
						<td ><?php echo $newArray['incident_happen'] ?></td>
		...
		<p style="font-size:15px">Injury Details</p>
            <table id="tableRemark1" style="width: 100%;" class="TFtable">
                <thead>
                    <tr class="pluginth">
                        <th style="width: 30px;">No.</th>
						<th style="width: 300px;">Location<font color="#E6E6E6">_</font>of<font color="#E6E6E6">_</font>Injury: Multiple<font color="#E6E6E6">_</font>Location</th>
                        <th style="width: 150px;">General<font color="#E6E6E6">_</font>Injuries/Poisonings/Diseases</th>
                        <th style="width: 200px;">Location<font color="#E6E6E6">_</font>of<font color="#E6E6E6">_</font>Injury: Head</th>
                        <th style="width: 300px;">Location<font color="#E6E6E6">_</font>of<font color="#E6E6E6">_</font>Injury: Neck</th>
						 <th style="width: 300px;">Location<font color="#E6E6E6">_</font>of<font color="#E6E6E6">_</font>Injury: Upper Limb</th>
						  <th style="width: 300px;">Location<font color="#E6E6E6">_</font>of<font color="#E6E6E6">_</font>Injury: Trunk</th>
						   <th style="width: 300px;">Location<font color="#E6E6E6">_</font>of<font color="#E6E6E6">_</font>Injury: Lower limb</th>
