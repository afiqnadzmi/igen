        ...
        <div class="plugindiv">
			...
			<td>' . $gname . '</td>';
                    if ($igen_a_m == "a_m_edit") {
                        echo '<td class="aligncentertable"><a href="javascript:void()" onclick="edit(' . $id . ', ' .$dep_id. ')"><input type="button" style="width:40px" value="Edit" id="editBut"></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="javascript:void()" onclick="delete_group(' . $id . ')"><input type="button" style="width:50px" value="Delete" id="editBut"></a></td>';
