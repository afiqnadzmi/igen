        ...
        <td>
				...
				?>
				 <tr>
                    ...
                    </tr></table><table style="position:relative; top:-400px; left:500px">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="padding-top:6px;">
                            ...
                            ?>
                            <select id="dropSpouse" style="width:250px;" <?php echo $dis_spouse; ?>>
                                <option value="0">--Please Select--</option>
                                <option value="Y" <?php
				...
				<tr>
								...
								<tr>
                                    <td style="padding-top:6px;width:200px;">Relationship</td>
                                    <td style="padding-top:6px; "><input type="text" style="width:250px;" id="emr" value="Siblings" ></td>
                                </tr>
				</table></div>
         ...
         <!--<td><br>
           <fieldset style="width:550px;padding-left: 50px;height:300px">
                <legend style="font-size: 16px; font-weight: bold;">&nbsp;&nbsp;Profile&nbsp;&nbsp;</legend>
                <table>

                    <tr>
                        <td style="padding-top:6px;width:200px">Username</td>
                        <td style="padding-top:6px;width:200px;"><input type="text" id="usernameText"  value="<?php echo $row['username'] ?>" style="width:250px;"/>
                    </tr>
                    <tr>
            ...
            <fieldset style="width:550px;padding-left: 50px;margin-top:5px;height:420px">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td style="padding-top:6px;width:200px"><input id="bankAccNumText" type="Text" value="<?php echo $row['bank_acc_num'] ?>" disabled="disabled" style="width:250px"/></td>
                    </tr>
                    <tr>
