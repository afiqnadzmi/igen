...
<div class="main_div">
        ...
        <div id="container" class="tablediv">
            <table>
				...
				<tr style="display:none" class="start">
                    ...
                    <td rowspan="4" style="vertical-align: top;"><textarea class="input_textarea" id="Reason1" style="width: 250px; height: 100px;" ></textarea></td>
                </tr>
				 <tr style="display:none" class="start"> 
                ...
                <tr style="display:none" class="time">
                    ...
                    <td>
                        <input class="input_text" id="hours_off" type="text"  value="" style="width: 250px;" readonly=true />
                        <input type="hidden" id="getDays" />
                    </td>
                </tr>
	...
	*/
	...
	<br/><br/>
        <div class="header_text">
            <span>Employee Movement History</span>
		...
		<h2> Movement </h2>
		 <div class="main_content">
            ...
            <div class="plugindiv">
		 <table id="tableplugin1" style="border-collapse: collapse;width: 100%; font-size: 13px;">
                    <thead>
                        <tr class="pluginth" id="alternatecolor">
                            <th style="width:30px;">No.</th>
                    ...
                    echo '<td class="aligncentertable">' . $status . '</td> ';
                        if ($status == "Pending") {
                            echo '<td class="aligncentertable"><a href="javascript:void()" onclick="deleteid1(' . $id . ')">Revoke</a></td> ';
                        } else {
                            echo '<td class="aligncentertable">-</td> ';
                        }
                        echo'</tr>';
...
//create date format          
 var timeStart = new Date('"' + date +'"' + valuestart);
	...
	alert("E-movement is only allowed for 2 hrs")
