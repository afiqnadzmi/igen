...
$sql = "SELECT et.id,e.full_name,t.training_name,et.request_date,e.id as eid
			FROM employee_training et
			join employee e on et.employee_id=e.id
			join training t on et.training_id=t.id where et.id=" . $_GET["id"];
$rs = mysql_query($sql);
