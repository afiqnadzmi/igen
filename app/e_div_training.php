...
<div class="pluginDiv" style="padding-bottom: 5px;">
    <div id="loanDiv" style="width:97%;border:solid;border-color:lightgrey;padding: 8px 10px 10px 10px;">
        ...
        <div id="changeDiv2">
           ...
           <table id="table_p" class="TFtable" style="border-collapse: collapse;width: 100%; font-size: 13px;">
                <thead>
                    <tr class="pluginth">
                        ...
                        <th class="aligncentertable" style="width: 100px;">Attachment</th>
                    </tr>
                </thead>
                <?php
                ...
                while ($row = mysql_fetch_array($rs)) {
                   ...
                   // $mouseover = 'class="cursor_pointer" onMouseover="emp_app(' . $training_id . ')" onMouseout="emp_app_hide()"';
                    ...
                    if ($num_rows3 == 0) {
                        ...
                        if ($attach != "") {
                           echo '<td class="aligncentertable"><a href="uploads/transcript/' .$attach. '" target="_blank"><i class="fas fa-download" style="color:#000;" aria-hidden="true"></i></a></td>';
                        } else {
                          echo'<td style="width:150px; cursor:pointer"><i class="fas fa-upload" style="color:#000;" aria-hidden="true" onclick="upload_training('.$emptrain_id.')></i></td>';
                        }
                    }
