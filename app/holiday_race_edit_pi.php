...
<div class="main_div">
        ...
        <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <a href="#collapseone" data-toggle="collapse" data-parent="accordion">Holiday by Race Maintenance</a>
                    </h4>
                </div>
        </div>
    </div>
    ...
    <div class="header_text">
        <span>Holiday by Race Maintenance</span>
    </div>
    <div class="main_content">
        <div class="tablediv">
            <table>
                ...
                <tr>
                    <td style="width: 200px;">Race Name</td>
    ...
    <br/><br/>
    <div class="header_text">
        <span>Holiday by Race List</span>
    </div>
    <div class="main_content">
        <div class="plugindiv">
            <table id="tablecolor" class="TFtable">
                <thead>
                    <tr class="pluginth">
                        ...
                        <th style="width:150px">Race Name</th>
    ...
    function deleteholiday(id,num_row){
        ...
        if(result == true){
            if(num_row <= 0){
                ...
                alert("Holiday by Race Can't be Deleted");
            }
        }
    }
