 ...
 $sql = "INSERT INTO appraisal_audit(rate, new_rate, changed_date, changed_by, q_id) VALUES ('" . $row_q['rate'] . "','" . $_POST["rating"][$i] . "','" . $curnt_time. "','" .$emp_name. "','" .$thisName. "')";
    ...
    if($query){
		...
		echo"<script type='text/javaScript'>
			 ...
			 self.location='?eloc=emp_appraisal&id=".$_GET['id']."'";
...
<div class="main_div">
	...
	<div class="expandable-panel" id="cp-1" style="margin-left:0px">
        <div class="expandable-panel-heading">
            <h2>MY APPRAISAL<span class="icon-close-open"></span>
        ...
        <div class="expandable-panel-content">
			...
			<span style="margin-left:80%; position:relative; top:30px"><input type="button" class="button" value="Export" onclick="exp()"> <input type="button" class="button" onclick="back()" value="Back"></span>
			
<div id="app" >

    <br/>
    
    <div class="main_content" style="width:90%; margin-left:30px">
        <div id="container" class="tablediv" style="margin-left:100px">
...
<form action="?eloc=emp_appraisal&id=<?php echo $_GET['id'];?>" name="form1" method="post" >


<fieldset style="width:100%;padding:10px 10px 10px 10px;height:auto; margin-left:-50px; border:1px solid silver">
<legend style="font-size: 14px; ">&nbsp;&nbsp; Appraisal &nbsp;&nbsp;</legend><br><br>
...
?>
<br>
<table id="e" style="border:1px solid">
<?php
...
<span style="cursor:pointer"  title="<?php echo $count.' '.$a ?> has been Made To This Question. Click To See More Details" class="audit" alt="<?php  echo $row_q['id'];  ?>"><img  style="Margin-left:50px; cursor:pointer" src="images/ch.png" width="20px" ><span Style="position:absolute; Margin-left:166px; margin-top:1px; color:#FFF; font-weight:bold; "><?php echo $count ?></h5></span> </span>
...
<?php
if($status!="FINILIZED" && $userID==$emp_id){
...
<div class="main_div">
	...
	<div class="expandable-panel" id="cp-1">
        <div class="expandable-panel-heading">
            <h2>MY APPRAISAL<span class="icon-close-open"></span></h2>
         </div>
        <div class="expandable-panel-content">
...
<img src="images/edit.png" style="text-align:center" onClick="process(<?php echo $row_r['id'] ;?>)">
