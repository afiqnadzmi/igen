        ...
        <div id="divappend" class="main_content">
			...
			<table id="tbl" class="bordercollapse" style="width: 100%;">
                ...
                <div style="border: 1px solid black;">
				 ...
				 <table id="tbl1" class="bordercollapse" style="width: 100%;">
                        <tr class="tableth" id="calintr1" >
						  <th style="width: 180px;">ID</th>
                            <th style="width: 180px;">Department</th>
                            <th>Name</th>
                            <th style="width: 130px;">Increment By</th>
                            <th style="width: 220px;">Before(RM)</th>
                            <th style="width: 220px;">After (RM)</th>
						...
						$sym="Month";
                           ...
                           $query2 = mysql_query($sql3);
							  ...
							  $increment_by=$increment_by_amount." RM";
            ...
            <td style="width: 220px;"><span name="stotal">' . $increment_by. '</span></td>  			
            <td style="width: 220px;"><span name="atotal">' . number_format($Before_Increment, 2, ".", "") . '</span></td>
			<td style="width: 180px;">' . number_format($after_increment, 2, ".", "") . '</td>
			<td style="width: 180px;">' . number_format($difference, 2, ".", "") . '</td>
			...
			$count++;
				   ...
				   <table id="tbl" class="bordercollapse" style="width: 100%;" style="display:">
                     
						

                        <tr class="tableth" id="calbonustr" style="display:none">
						    <th style="width: 180px;">ID</th>
                            <th style="width: 180px;">Department</th>
                            <th>Name</th>
                            <th style="width: 180px;">Before (RM)</th>
						...
						$sym="Month";
                           ...
                           $query2 = mysql_query($sql3);
							  ...
							  $id=$row['id'];
							  $sym="RM";
							   echo '<tr class="tabletr" style="display:none">
			<td style="width: 180px;">' . $count . '</td>
            <td style="width: 180px;">' . $dep_name . '</td>
            <td><input type="hidden" id="empid" value=' . $empid . ' />' . $emp_name . '</td>
			...
			<td class="alignrighttable"><input type="button" value="Delete" class="button" onclick="cleartext2('.$id.')" style="width: 70px;" /></td>
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    if(data != false){
                        ...
                        total();
						   window.location='?loc=simulation1';
                    }else{
                        alert('Error While Proccessing'); 
                    }
                }
