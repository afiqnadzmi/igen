...
<div id="container" class="main_div">
		...
		<div class="panel panel-default">
				<div class="panel-heading">
					<h4 class="panel-title">
						<a href="#collapseone" data-toggle="collapse" data-parent="accordion">Section/Unit Maintenance</a>
					</h4>
				</div>
		</div>
	</div>
    ...
    <div class="header_text">
        <span>Section/Unit Maintenance</span> 
    </div>
        ...
        <div class="plugindiv">
            <table id="tablecolor" class="TFtable">
                ...
                while ($newArray = mysql_fetch_array($sql_result)) {
                    ...
                    <a style='font-size: 10pt;color:blue;' title='Edit' href='?loc=group&gid=" . $newArray['gid'] . "&did=" . $newArray['gdepid'] . "&empid=" . $newArray['empid'] . "'><i class='far fa-edit' style='color:#000;' ></i></a>
                    </td>";
                    } elseif ($igen_a_m == "a_m_view") {
                        echo "<td class='aligncentertable'>
                    <a style='font-size: 10pt;color:blue;' title='View' href='?loc=group&view_id=" . $newArray['gid'] . "&did=" . $newArray['gdepid'] . "&empid=" . $newArray['empid'] . "'><i class='far fa-eye' aria-hidden='true'></i></a>
                    </td>";
                    }
                    echo "</tr>";
                }
...
<script type="text/javascript">
    ...
    function del(id, head_count){
        ...
        if(result == true){
            if(head_count <= 0){
                ...
                alert("Section/Unit Can't be Deleted");
            }
        }
    }
    ...
    function e_save_func(id){
        ...
        if(groupstatus == ""){
            error3.push("Section/Unit Status");
        }
        var error_data1 = '';
