		...
		<div class="panel panel-default">
				<div class="panel-heading">
					<h4 class="panel-title">
						<a href="#collapseone" data-toggle="collapse" data-parent="accordion">Employee Attendance</a>
					</h4>
				</div>
		</div>
	</div>
    ...
    <div class="header_text">
        ...
        <span style="float: right;margin-top: -5px">
            <?php if ($igen_a_m == "a_m_edit") { ?>
                <table>
                    <tr>
                        <td><input class="button" type="button" onclick="window.location = '?loc=import_attendance';" value="Import" style="width:100px; margin-right: 4px;" /></td>
                        <td><input class="button" type="button" onclick="window.location = '?loc=time_attendance_add';" value="Key In" style="width:100px;margin-right: 4px;" /></td>
                    </tr>
                </table>
            <?php } ?>
        </span>
            ...
            <table id="tablecolor1" class="TFtable">
                ...
                while ($row = mysql_fetch_array($rs)) {
                    ...
                    echo '<tr class="plugintr">
                          <td>' . $i . '</td>
                          <td><span class="bold">EMP' . str_pad($emp_id, 6, "0", STR_PAD_LEFT) . '</td> 
                          <td>' .$emp_name. '</td>
						  <td>' . $att_year . ' ' . $month[$att_month] . '</td>';
						  
                    if ($igen_a_m == "a_m_edit") {
                        echo '<td class="aligncentertable"><a title="Edit" href="?loc=time_attendance&action=1&emp_id=' . $emp_id . '&year=' . $att_year . '&month=' . $att_month . '"><i class="far fa-edit" style="color:#000;"></i></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a title="Delete" href="javascript:deleteatt(' . $emp_id . ', ' . $att_year . ', ' . $att_month . ')"><i class="fas fa-trash-alt" style="color:#000;"></i></a></td>';
                    } elseif ($igen_a_m == "a_m_view") {
                        echo '<td title="View" class="aligncentertable"><a href="?loc=time_attendance&action=2&emp_id=' . $emp_id . '&year=' . $att_year . '&month=' . $att_month . '"><i class="far fa-eye" aria-hidden="true"></i></a></td>';
                    }
                    echo '</tr>';
                }
                ?>  
    ...
    if (isset($_GET["action"]) == true && ($_GET["action"] == "1" || $_GET["action"] == "2")) {
        ...
        <div id="content_time_att" class="main_content">
            <div class="tablediv">
                ...
                <table id="table_time_att" class="TFtable">
                    <tr>
