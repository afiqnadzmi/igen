...
<div class="main_div">
   <div class="panel-group" id="accordion">
		<div class="panel panel-default">
				<div class="panel-heading">
					<h4 class="panel-title">
						<a href="#collapseone" data-toggle="collapse" data-parent="accordion">Loan Maintenance</a>
					</h4>
				</div>
		</div>
	</div>
    ...
    <?php if ($igen_a_m == "a_m_edit") { ?>
        <div class="header_text">Loan Maintenance</div>
        <div class="main_content">
            <div class="tablediv">
                <?php
                if (isset($_GET['aid']) == true) {
                    $sql_result = mysql_query("SELECT * FROM loan_management WHERE id = " . $_GET['aid'] . ";");
                    while ($newArray1 = mysql_fetch_array($sql_result)) {
                        ...
                        <table>
                            ...
                            <tr>
                                <td style="width: 200px;">Loan Name</td>
...
<script type="text/javascript">
    function view(id){
        window.location="?loc=loan_management&view_id=" + id;
    }
    function clearNew(){
        window.location='?loc=loan_management';
    }
    function edit(id){
        window.location="?loc=loan_management&aid=" + id;
    }
