...
<script type="text/javascript">
    ...
    function check_view(view){
	   view=view.trim();
        if(view == "Resignation Report"){ 
            ...
            $('#year_picker').hide();
            $('.view_button').show();
        }else if(view == "Allowance & Deduction" || view == "Employee EPF Report"||view == "Employer Socso Report"||view == "Socso Report"|| view == "EPF_Socso_Tax Report" || view == "Gross Paid Report" || view == "Net Paid Report" || view == "PCB Report" || view == "EPF Report" || view == "Salary Report"){
            $('#show_all').hide();
            $('#date_picker').hide();
            $('#year_picker').hide();
            $('#month_picker').show();
    ...
    function view_func(){
        ...
        }else if($.trim(view) == "Employee Report"){
            var emp_show = $('#emp_showall').is(':checked');
            if(emp_show == false){
                if(from != "" && to != ""){
        ...
        }else if($.trim(view)== "Allowance & Deduction"){
            if(month != "" && year != ""){
        ...
        }else if($.trim(view)== "Employer Socso Report"){
            if(month != "" && year != ""){
