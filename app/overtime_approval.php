...
$sql = "SELECT *,e.id as eid FROM employee_overtime eo
    ...
    <div class="main_content">
        <div class="tablediv">
            <table>
                ...
                <tr>
                    <td>Overtime Date</td>
                    <td><?php echo date("d-m-Y", strtotime($row["ot_date"])) ?></td>
                </tr>
                <tr>
                    <td>From Time</td>
