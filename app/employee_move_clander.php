...
$e_sql = "SELECT e.id
          ...
          WHERE (MONTH(from_time) = " . $month . " or  MONTH(to_time) = " . $month . ")
          and (year(from_time) = " . $year . " or  year(to_time) = " . $year . ")
    ...
    <body>
        ...
        <div class="main_div" style="width:100%">
            ...
            <div class="header_text">
                <span>Employee Movement Calendar</span>
            </div>
                    ...
                    <td style="vertical-align: top;">
                            ...
                            <tr>
                                <td>
                                    <div style="height:25px;padding:4px;float:left;width:300px">
                                        <span class="currentdate" style='margin-top:5px'><a href="?loc=leave_calendar&m">Monthly</a></span>
                                        &nbsp;|&nbsp;
                                        <span class="currentdate" style='margin-top:5px'><a href="?loc=leave_calendar&m&sun_date=">Weekly</a></span>
                                    </div>
                                    <div style="height:25px;padding:4px;float:right;width:310px">
                                        ...
                                        &nbsp;|&nbsp;
                                        <span style="cursor:pointer;text-decoration:underline;color:blue;" onclick="show_leave('<?php echo date("m", mktime(0, 0, 0, $_GET['month'] - 1, 1, $_GET['year'])) ?>','<?php echo date("Y", mktime(0, 0, 0, $_GET['month'] - 1, 1, $_GET['year'])) ?>')">Show All <?php echo $sum_emp ?> Employees' Movement</span>
                                        ...
                                        <table width="700" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            if (!isset($_GET["sun_date"])) {
                                                ...
                                                <tr> 
                                                    <td>
                                                        <div align="left">
                                                            <a href="<?php echo "?loc=leave_calendar&m&month=$prev_month&amp;year=$prev_year"; ?>">
                                                        ...
                                                        <div align="center">
                                                            <select name="month" id="month" onChange="MM_jumpMenu('parent',this,0)">
                                                                ...
                                                                for ($i = 1; $i <= 12; $i++) {
                                                                    ...
                                                                    echo "<option value=\"?loc=leave_calendar&m&month=$link&amp;year=$_GET[year]\" $selected>" . date("F", mktime(0, 0, 0, $i, 1, $_GET['year'])) . "</option>\n";
                                                                }
                                                                ?>
                                                            </select>
                                                            <select name="year" id="year" onChange="MM_jumpMenu('parent',this,0)">
                                                                ...
                                                                for ($i = (int) date('Y') - 1; $i <= ((int) date('Y') + 1); $i++) {
                                                                    ...
                                                                    echo "<option value=\"?loc=leave_calendar&m&month=$_GET[month]&amp;year=$i\" $selected>$i</option>\n";
                                                                }
                                                                ?>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <td>
                                                        <div align="right">
                                                            <a href="<?php echo "?loc=leave_calendar&m&month=$next_month&amp;year=$next_year"; ?>">
                                                ...
                                                <tr> 
                                                    <td>
                                                        <div align="left">
                                                            <a href="<?php echo "?loc=leave_calendar&m&month=" . ((int) date("n", mktime(0, 0, 0, $_GET['month'] - 1, ($sun_date - 7), $_GET['year'])) + 1) . "&amp;year=" . date("Y", mktime(0, 0, 0, $_GET['month'] - 1, ($sun_date - 7), $_GET['year'])) . "&sun_date=" . date("j", mktime(0, 0, 0, $_GET['month'] - 1, ($sun_date - 7), $_GET['year'])); ?>">
                                                                <img style="border:0" src="images/prev_month.gif" />
                                                            </a>
                                                        </div>
                                                    </td>
                            ...
                            <tr valign="" bgcolor="#FFFFFF"> 
                                ...
                                if (!isset($_GET["sun_date"])) {
                                    ...
                                    for ($i = 1; $i <= $days_in_month; $i++) {
                                        ...
                                        $sql = "select count(el.id) as s from employee_movement1 AS el
                                                JOIN employee AS e
                                                ON e.id = el.emp_id
                                                where el.request_status='Approved' " . $sqlAdd . " and 
                                                (el.from_time='" . $this_date . "' or el.to_time='" . $this_date . "' or (el.from_time<'" . $this_date . "' and el.to_time>'" . $this_date . "'))";
                                        $rs = mysql_query($sql);
                        ...
                        if (isset($_GET["sun_date"])) {
                            ...
                            <table style="width:730px;border-collapse:collapse;border:5px solid #C4C4C7;">
                                <tr>
                                    <td colspan="5" style="padding: 5px;">Employees' Movement from <b><?php echo $d1 ?></b> to <b><?php echo $d2 ?></b></td>
                                </tr>
                                ...
                                $el_sql = "select * from employee_movement1 el join employee e on el.emp_id=e.id
                                           where request_status='Approved' and ((el.from_time>='" . $d1 . "' and el.from_time<='" . $d2 . "')
                                           or (el.to_time>='" . $d1 . "' and el.to_time<='" . $d2 . "')
                                           or (el.from_time<='" . $d1 . "' and el.to_time>='" . $d2 . "'))" . $sqlAdd;
                                //echo $el_sql;
                                ...
                                if ($el_rs && mysql_num_rows($el_rs) > 0) {
                                    while ($el_row = mysql_fetch_array($el_rs)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $el_row["from_time"]; ?></td>
                                            <td><?php echo $el_row["to_time"]; ?></td>
                                            <td><?php echo $el_row["num_hours"]; ?></td>
                                        </tr>
                                        <?php
                                        $i++;
                                    }
...
function create_date($sun_date, $month, $year, $igen_branchlist) {
    ...
    for ($i = 0; $i < 7; $i++) {
        ...
        $sql = "select count(el.id) as s from employee_movement1 AS el
                ...
                and (el.from_time='" . $this_date . "' or el.to_time='" . $this_date . "' or (el.from_time<'" . $this_date . "' and el.to_time>'" . $this_date . "'))"
                . $sqlAdd;
        $rs = mysql_query($sql);
         if ($rs && mysql_num_rows($rs) > 0) {
                                            $row = mysql_fetch_array($rs);
