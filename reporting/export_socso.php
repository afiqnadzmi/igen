...
$workbook->send('Socso_sample.xls');
$worksheet1->write(0, 0, 'Socso Report');
$worksheet1->write(1, 0, "From Amount");
$worksheet1->write(1, 1, "To Amount");
$worksheet1->write(1, 2, "Employer Rate");
$worksheet1->write(1, 3, "Employer Rate2");
$worksheet1->write(1, 4, "Deduct Rate");


$sql = "SELECT * FROM employee_socso";
...
if ($sql_result && mysql_num_rows($sql_result) > 0) {
    while ($newArray = mysql_fetch_array($sql_result)) {
        ...
        $worksheet1->write($i, 3, $newArray['employer_rate2']);
