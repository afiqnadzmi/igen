...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="font-family: 'century gothic';">
       ...
       $selection=2;
		...
		$epf_number=$row['epf_num'];
		$socso_number=$row['socso_num'];
		$tax_number=$row['income_tax_num'];
        ...
        //while ($row = mysql_fetch_array($rs)) {
			...
			$employee_total_eis = employee_total_eis($emp_id, $year, $month);
			$employer_total_eis = employer_total_eis($emp_id, $year, $month);
			...
			$get_eis = $p_row['eis'];
			$get_employer_eis = $p_row['employer_eis'];
			$get_employee_eis = $p_row['employee_eis'];
            $get_pcb = $p_row['pcb'];
			$get_zakar  = $p_row['zakat'];
			...
			<img src="<?php echo $rowCompany["logo_img"] ; ?>" width="100px" style="padding-left: 350px;" >
                <table style="width: 100%;">
                    <tr><td style="text-align: center;font-weight: bold; font-size: 23px; padding-top: 0px;"><?php echo $rowCompany["name"]; ?></td></tr>
                    <tr>
				
                        <td style="text-align: center; padding-bottom: 2px;">
						
                            <?php echo $rowCompany["address1"] . '&nbsp;' . $rowCompany["address2"] . '<br/>' . $rowCompany["postal_code"] .' ' . $rowCompany["country"]; ?>
                        </td>
                    </tr>
                    <tr><td style="text-align: center; border-bottom: 1px solid black; border-top: 1px solid black; font-size: 18px; padding: 2px;; font-weight: bold">
                    ...
                    <tr>
                        <td>
                            <div style="margin-left: 30px; padding: 5px 0px;">
                                <table style="border-spacing: 5px; font-weight: bold; font-size: 14px;">
                                    <tr>
                                        <td style="width: 450px;">Employee Name</td>
                                        <td style="width: 300px; padding-left: 10px;"><?php echo $get_name ?></td>
										<td style="width: 200px;">EPF No.</td>
                                        <td style="width: 300px; padding-left: 10px;"><?php echo $epf_number ?></td>
                                    </tr>
                                    <tr>
                                        <td>Position</td>
                                        <td style="padding-left: 10px;"><?php echo $get_designation; ?></td>
										<td>SOCSO No.</td>
                                        <td style="padding-left: 10px;"><?php echo $socso_number; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Month & Year</td>
                                        <td style="padding-left: 10px;"><?php echo $full_month . ' ' . $year; ?></td>
										 <td>Tax No. </td>
                                        <td style="padding-left: 10px;"><?php echo $tax_number ?></td>
                                    </tr>
                                </table>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td>
                            <div style="border-style: solid; border-width: 1px; width: 800px; padding: 5px 0px 0px 0px; margin-left: 20px;">
                                <table border="0" style="border-spacing: 2px; font-size: 14px;">
						...
						if ($num_row > 0) {
							...
							while ($row = mysql_fetch_array($rs_claim)) {
								...
								if($i / 2 == 1){
								  $style="";
								  /* $str=$str.'
									<td style="padding-left: 20px" >'.ucfirst($row['claim_type']).'</td>
									<td style="padding-right: 20px">(RM)</td>
									<td style="padding-right: 50px" >'.number_format($row['claim_amount'], 2).'</td>';*/ 
								}else{
								/*$str2=$str2.'
									<td style="'.$style.'" >'.ucfirst($row['claim_type']).'</td>
									<td style="padding-right: 20px">(RM)</td>
									<td style="padding-right: 50px" >'.number_format($row['claim_amount'], 2).'</td>'; */
								}
								if ($i > 2 && $i/2!=1) {
							    ...
							    echo '<td style="'.$style.'" >'.ucfirst($row['claim_type']).'</td>
									<td style="padding-right: 20px">(RM)</td>
									<td style="padding-right: 50px" >'.number_format($row['claim_amount'], 2).'</td>';
				   ...
				   <?php     
						...
						if ($num_row_deduction > 0) {
							...
							?>	
									...
									<td>(RM)</td>
									<td style="" ><?php echo number_format($row_deduction['deduction_amount'], 2) ?></td>                 
				...
				<?php
					...
					?>
					     ...
					     <tr>
                                    ...
                                    <tr>
                                        <td style="padding-left: 20px;">Employee EPF</td>
                                        <td style="padding-right: 20px">(RM)</td>
                                    ...
                                    <tr>
                                        <td style="padding-left: 20px;">Employee Socso</td>
                                        <td style="padding-right: 20px">(RM)</td>
									 ...
									 <tr>
                                        <td style="padding-left: 20px;">Employee EIS</td>
                                        <td style="padding-right: 20px">(RM)</td>
                                        <td style="padding-right: 50px"><?php echo number_format($get_employee_eis, 2) ?></td>
                                        <td>Employer EIS</td>
                                        <td style="padding-right: 20px">(RM)</td>
                                        <td style=""><?php echo number_format($get_employer_eis, 2) ?></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-right: 50px"><?php echo number_format($get_pcb, 2) ?></td>
										   <?php if ($get_zakar > 0) { ?>
                                            ...
                                            <td style="">Zakat </td>
                                            <td style="padding-right: 20px">(RM)</td>
                                            <td style=""><?php echo number_format($get_zakar, 2) ?></td>   
                                    ...
                                    <tr>
                                        <td style="padding-left: 20px;">Total Employee EPF</td>
                                        <td style="padding-right: 20px">(RM)</td>
                                    ...
                                    <tr>
                                        <td style="padding-left: 20px;">Total Employee Socso</td>
                                        <td style="padding-right: 20px">(RM)</td>
									 ...
									 <tr>
                                        <td style="padding-left: 20px;">Total Employee EIS</td>
                                        <td style="padding-right: 20px">(RM)</td>
                                        <td style="padding-right: 50px"><?php echo number_format($employee_total_eis, 2) ?></td>
                                        <td>Total Employer EIS</td>
                                        <td style="padding-right: 20px">(RM)</td>
                                        <td style=""><?php echo number_format($employer_total_eis, 2) ?></td>
                                    </tr>
                    ...
                    <tr>
                        <td style="padding-bottom: 10px; padding-top: 5px;">
                            <div style="margin-left: 30px;">
                                <table style="border-spacing: 2px; font-size: 14px;">
                                    <tr>
