...
if ($_POST["employee_id"] == "0" || $_POST["employee_id"]=="undefined") {
...
$sql = "INSERT INTO employee_leave (emp_id, depid, from_date,to_date,reason,leave_type_id,leave_date,request_status,num_days, img_path)
        VALUES ('" . $emp_id . "','" . $depid. "','". date('Y-m-d', strtotime($_POST['startdate'])) . "','" . date('Y-m-d', strtotime($_POST['enddate'])) . "','" .$reason 
        . "','" . $_POST['Leave_type'] . "','" . date('Y-m-d') . "','Pending','" . $_POST['Days_off'] . "','" .$filename. "');";
