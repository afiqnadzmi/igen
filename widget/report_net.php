...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Net Paid Report For <?php echo $month[$_GET['month']] ?> <?php echo $_GET['year'] ?></title>
        <style type="text/css">
            .tableth th{
    ...
    <body>
        <p style="text-align: center;font-size:large;"><b>Net Paid Report For <?php echo $month[$_GET['month']] ?> <?php echo $_GET['year'] ?></b></p>
        ...
        <table border="1" style="border-collapse:collapse;width:100%;">
            ...
            if ($chk_sql_result && mysql_num_rows($chk_sql_result) > 0) {
                ...
                if ($sql_result && mysql_num_rows($sql_result) > 0) {
                    ...
                    echo "<td>" . number_format($pcd, 2) . "</td>";
                    echo "<td>" . number_format($claim, 2) . "</td>";
