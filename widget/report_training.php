...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Training Report For <?php echo $_GET['from'] ?> to <?php echo $_GET['to'] ?></title>
        <style type="text/css">
            .tableth th{
    ...
    <body>
        <p style="text-align: center;font-size:large;"><b>Training Report For <?php echo $_GET['from'] ?> to <?php echo $_GET['to'] ?></b></p>
        <table border="1" style="border-collapse:collapse;width:100%;">
			...
			<td>" . $newArray['training_name'] . "</td>
			<td>" . $newArray['request_date'] . "</td>
			<td>" . $newArray['duration'] . "</td>
			<td>" . $newArray['feedback'] . "</td>
			<td>" . $newArray['result'] . "</td>
			</tr>";
                }
            } else {
                echo "<tr class='tabletr'>
