...
$sql_3 = "SELECT * FROM employee_movement WHERE
                            id=" . $id ;
...
$sql = "SELECT * FROM employee_movement WHERE id = " . $id;
$rs = mysql_query($sql);
$row = mysql_fetch_array($rs);
...
if ($status == "Rejected") {
 $msg = '<p>Dear ' . $name . '</p>';
	  $msg.='<p>&nbsp</p>';
       ...
       mailto($email, $subject, $msg, $headers);
    if ($aid1 == 1) {
        $sql2 = "UPDATE employee_movement SET approval_1='" . $status . "' where id='" . $id . "'";
    } elseif ($aid2 == 2) {
        $sql2 = "UPDATE employee_movement SET approval_2='" . $status . "' where id='" . $id . "'";
    }
    $sql1 = "UPDATE employee_movement SET request_status='" . $status . "' where id='" . $id . "'";
} else {
    if ($aid1 == 1) {
    ...
    $sql1 = "UPDATE employee_movement SET " . $approve . " where id='" . $id . "'";
}
