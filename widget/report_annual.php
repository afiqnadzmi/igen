...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Annual Report For <?php echo $_GET['year'] ?></title>
        <style type="text/css">
            .tableth th{
    ...
    <body>
        <p style="text-align: center;font-size:large;"><b>Annual Report For <?php echo $_GET['year'] ?></b></p>
