    ...
    <div style="padding-left: 10px;">
        ...
        <table style="border-spacing: 10px;">
            ...
            <?php } elseif ($letter_id == 3) { ?>
				...
				<tr>
                    <td class="bold">Increment Amount (RM)</td>
                    <td><input type="text" id="i_amount" style="width: 200px;" /></td>
                </tr>
    ...
    function confirmbutton(letter_id){
        ...
        if(letter_id == 1){
            ...
            if(company == "" || company == " "){
			 ...
			 if(i_amount == "" || i_amount == " "){
                error1.push('Increment Amount');
            }
            if(name == "" || name == " "){
                error1.push('Name');
            }
            ...
            url = 'doc='+doc_no+'&entrysk='+entrydate+'&company='+company+'&name='+name+'&sal='+salutation+'&add='+address+'&date='+datecommencement+'&iamount='+i_amount+'&salary='+salary+'&byname='+byname+'&bypos='+byposition;
			...
			*/
            url = 'doc='+doc_no+'&entry='+entrydate+'&company='+company+'&name='+name+'&sal='+salutation+'&add='+address+'&email='+email+'&byname='+byname+'&bypos='+byposition+'&wtitle='+wtitle+'&reason='+reason;
        }
