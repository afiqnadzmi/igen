    ...
    <div style="padding-left: 10px;">
        ...
        <table style="border-spacing: 10px;">
            ...
            <?php if ($letter_id == 1) { ?>
				...
				<tr>
                    <td class="bold">Transport Allowance (RM)</td>
                    <td><input type="text" id="tr" style="width: 200px;" /></td>
                </tr>
				<tr>
                    <td class="bold">Telephone Allowance (RM)</td>
                    <td><input type="text" id="ta" style="width: 200px;" /></td>
                </tr>
				<tr>
                    <td class="bold">Fixed OverTime</td>
                    <td><input type="text" id="ot" style="width: 200px;" /></td>
                </tr>
...
<script type="text/javascript">
    ...
    function confirmbutton(letter_id){
        ...
        if(letter_id == 1){
            ...
            url = 'doc='+doc_no+'&entry='+entrydate+'&company='+company+'&name='+name+'&sal='+salutation+'&tr='+tr+'&ot='+ot+'&ta='+ta+'&add='+address+'&pos='+position+'&date='+datecommencement+'&salary='+salary+'&ann='+annualleave+'&byname='+byname+'&bypos='+byposition;
            ...
            url = 'doc='+doc_no+'&entry='+entrydate+'&company='+company+'&name='+name+'&sal='+salutation+'&add='+address+'&byname='+byname+'&bypos='+byposition+'&wtitle='+wtitle+'&reason='+reason;
        }
