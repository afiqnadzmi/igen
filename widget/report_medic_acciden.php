...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Medical and Accident Report For <?php echo $_GET['from'] ?> to <?php echo $_GET['to'] ?></title>
        <style type="text/css">
            .tableth th{
    ...
    <body>
        <p style="text-align: center;font-size:large;"><b>Medical and Accident Report For <?php echo $_GET['from'] ?> to <?php echo $_GET['to'] ?></b></p>
