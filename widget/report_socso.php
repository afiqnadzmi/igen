...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Socso Report For <?php echo $month[$_GET["month"]] . ' ' . $_GET["year"]?></title>
        <style type="text/css">
            .tableth th{
    ...
    <body>
        <p style="text-align: center;font-size:large;"><b>Socso Report <?php echo $month[$_GET["month"]] . ' ' . $_GET["year"]?></b></p>
