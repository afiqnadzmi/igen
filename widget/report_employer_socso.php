...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Employer Socso Report</title>
        <style type="text/css">
            .tableth th{
    ...
    <body>
        <p style="text-align: center;font-size:large;"><b>Employer Socso Report For <?php echo $month[$_GET['month']] ?> <?php echo $_GET['year'] ?></b></p>
