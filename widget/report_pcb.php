...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>PCB Report For <?php echo $month[$_GET['month']] ?> <?php echo $_GET['year'] ?></title>
        <style type="text/css">
            .tableth th{
    ...
    <body>
        <p style="text-align: center;font-size:large;"><b>PCB Report For <?php echo $month[$_GET['month']] ?> <?php echo $_GET['year'] ?></b></p>
        ...
        <table border="1" style="border-collapse:collapse;width:100%;">
            ...
            if ($chk_sql_result && mysql_num_rows($chk_sql_result) > 0) {
                ...
                $sql1 = "SELECT e.full_name,e.ic,e.epf_num,p.* FROM payroll_report AS p 
                        ...
                        WHERE p.payroll_finalised_id=" . $fid . " and 1";
